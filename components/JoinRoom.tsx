...
export default function JoinRoom({ openTradeRoom, joinTradeRoom }) {
  return (
      ...
      <Card className="sm:max-w-lg">
        ...
        <div className="space-y-4 md:space-y-6 lg:space-y-8 sm:p-8">
          ...
          <div className="flex flex-row justify-center items-center mx-auto">
            <Button onClick={() => openTradeRoom()}>New Trade Room</Button>
            <Button onClick={() => joinTradeRoom({ roomId: "jingles" })}>Join Trade Room</Button>
          </div>
        </div>
      </Card>
    </div>
